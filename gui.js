...
(() => {
    ...
    const cheat = (async () => {
        ...
        const guiWrapper = createElement(
            ...
            (gui = createElement(
               ...
               /* createElement("div", {
                    ...
                    innerHTML: "",
                    onclick: () => window.open("https://github.com/Jamesy-tech", "_blank").focus(),
                }), */
                ...
                (cheatContainer = createElement(
                    "div",
                    {
                        ...
                        innerHTML: '<span style="margin-bottom:10px; display:block; text-shadow: 1px 1px rgb(0 0 0 / 40%)">Cheats</span>',
                    },
        ...
        addMode('<span style="font-size: 16px">Tower Defense 2</span>', [``], Cheats.defense2);
        addMode('<span style="font-size: 18px">Monster Brawl</span>', [``], Cheats.brawl);
        addMode('<span style="font-size: 17px">Deceptive Dinos</span>', [``], Cheats.dino);
        ...
        addMode('<span style="font-size: 18px">Tower Defense</span>', [``], Cheats.defense);
        ...
        addMode('<span style="font-size: 17px">Tower of Doom</span>', [``], Cheats.tower);
